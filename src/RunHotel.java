...
//                    break;
//                case 4:
//                    List<model.Guest> guests = h.selectGuest();
//                    System.out.println("Lista gości: ");
//                    for(model.Guest x:guests)
//                        System.out.println(x);
//                    break;
//                case 5:
//                    List<model.Employee> employee = h.selectEmployee();
//                    System.out.println("Lista pracowników:");
//                    for(model.Employee y: employee)
//                        System.out.println(y);
//                    break;
//                case 6:
//                    List<model.Apartment> apartments = h.selectApartment();
//                    System.out.println("Lista apartamentów:");
//                    for(model.Apartment z: apartments)
